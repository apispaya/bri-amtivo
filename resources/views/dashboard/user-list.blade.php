                                    ...
                                    <tbody>
                                        @foreach ($users as $i => $u)
                                            <tr class="product-removes inbox-data">
                                                <td></td>
                                                <td><p>{{ $users instanceof \Illuminate\Pagination\AbstractPaginator ? $users->firstItem() + $i : $loop->iteration }}</p></td>
            ...
            <div class="modal-content custom-input">
                ...
                <div class="modal-body">
                    <form id="user-form" class="needs-validation" method="POST" novalidate>
                        @csrf
                        {{-- when editing we inject @method('PUT') dynamically --}}
                        <div class="row g-3">
                            <div class="col-sm-6">
    ...
    <script>
        (function() {
            ...
            addBtn?.addEventListener('click', function() {
                ...
                setFormAction(@json(route('dashboard.users.store')));
                setFormMethod('POST');
