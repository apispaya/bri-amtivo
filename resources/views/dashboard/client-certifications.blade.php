                                    ...
                                    <tbody>
                                        @foreach ($certs as $i => $c)
                                            <tr class="product-removes inbox-data">
                                                ...
                                                <td>
                                                    <p>
                                                        ...
                                                        @if ($c->certificate_path)
                                                            <a class="pdf ms-1"
                                                                href="{{ Storage::url($c->certificate_path) }}"
                                                ...
                                                <td>
                                                    <p>Issued On
                                                        :<br><strong>{{ optional($c->issued_on)->format('d F Y') ?? '—' }}</strong>
                                                    </p>
                                                    <p>Effective Date
                                                        :<br><strong>{{ optional($c->effective_date)->format('d F Y') ?? '—' }}</strong>
                                                    </p>
                                                    <p>Expiry Date
                                                        :<br><strong>{{ optional($c->expiry_date)->format('d F Y') ?? '—' }}</strong>
                                                    </p>
                                                </td>
